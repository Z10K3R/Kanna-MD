...
global.ownernomer = process.env.SUDO || '966575731727' ; //add your Owner Number 
global.ownername = process.env.SUDO_NAME || '複|ZI0N' ; //add your owner name
global.ytname = "YT: X3N0Z" //blank
global.socialm = "GitHub: V-E-N-O-X" //blank
global.location = "Japan, 愛知県, 名古屋市" //ur location
global.botname = process.env.BOT_NAME || '複|HIRUKO' //add bot name
global.ownernumber = process.env.OWNER_NUM || '966575731727' ; //add your Owner Number 
global.ownername = process.env.OWNER_NAME || '複|ZI0N; //add your owner name
global.ownerNumber = ["966575731727@s.whatsapp.net"]
...
global.packname = process.env.PACK_NAME || 'ZI0N' ; //Add sticker packname
global.author = process.env.AUTHOR_NAME || '複|ZI0N' ; //add author name 
global.creator = "966575731727@s.whatsapp.net"
